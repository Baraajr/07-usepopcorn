...
function MovieDetals({ selectedId, onCloseMovie, onAddWatch, watched }) {
        ...
        <>
          ...
          <section>
            <div className="rating">
              {isWatched ? (
                <p>
                  you rated this before {watchedUserRating} <span>⭐</span>
                </p>
              ) : (
                <>
                  <StarRating
